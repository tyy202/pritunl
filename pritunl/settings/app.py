...
class SettingsApp(SettingsGroupMongo):
    ...
    fields = {
        ...
        'sso_client_cache_timeout': 2592000,
        'sso_client_cache_window': 86400,
        'sso_match': None,
        'sso_timeout': 60,
        'sso_org': None,
        'sso_azure_mode': 'org',
        ...
        'sso_connection_check_ttl': 3600,
        'sso_connection_check_rate': 2000,
        'server_sso_url': None,
        ...
        'route53_region': None,
        'route53_zone': None,
        'pritunl_cloud_host': None,
        'pritunl_cloud_token': None,
        'pritunl_cloud_secret': None,
        ...
        'ap_southeast_3_access_key': None,
        'ap_southeast_3_secret_key': None,
