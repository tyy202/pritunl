...
# Use private Nexus Go proxy first, fallback to proxy.golang.org, then direct
ENV GOPROXY=http://192.168.18.100:8081/repository/nas-go/,https://proxy.golang.org,direct
